...
<body>
	...
	<div class="main">
		...
		<form method="post" action="?action=login" onsubmit="writeCookie('username',this.username.value, 1)">
            ...
            <div class="inputbox">
                ...
                <dl>
					<dt>类型：</dt>
					<dd><input name="atype" type="radio" value="0" checked="checked"/>全功能版
					</dd>
				</dl>
            ...
            <dl>
					<dt></dt>
			  <dd>
                    <span style="color:#505050;font-size:12px;display:block">网站管理中心推出的以企业建站为基础的专业建站系统，帮助其实现一站式服务。</span>
	...
	<div class="copyright">
		Powered by 网站管理中心 Copyright &copy;2010-2013 
	</div>
